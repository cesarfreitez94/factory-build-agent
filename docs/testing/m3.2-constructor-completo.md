...
### 10. Verificar code-generator.md tiene todas las instrucciones Odoo v18

**Objetivo**: El agente code-generator documenta todos los tipos de vista, security y data rendering.

**Comando**:
```bash
python3 -c "
constructor_md = open('templates/.opencode/agents/code-generator.md').read()
...
print('code-generator.md has complete Odoo v18 rendering instructions')
"
```

**Resultado esperado**:
```
code-generator.md has complete Odoo v18 rendering instructions
```
